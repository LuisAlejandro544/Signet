...
object KeystoreGenerator {
    ...
    /**
     * Generates Gradle build.gradle.kts signing config snippet
     */
    ...
    fun generateApksignerSnippet(fileName: String, alias: String): String {
        return """
            # Firmar APK con apksigner (Android SDK Build-Tools):
            apksigner sign --ks ${fileName} --ks-key-alias ${alias} --out app-release-signed.apk app-unsigned.apk
