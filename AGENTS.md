...
Este archivo define las reglas de comportamiento, roles y estándares de calidad para cualquier agente de IA que interactúe con el repositorio **Keystore Generator**.
...
1. **Criptografía**:
   ...
   - Mantener el motor BouncyCastle aislado en `com.example.crypto.KeystoreGenerator`.
